        ...
        <section class="section about" id="about" aria-label="about">
          <div class="container">
            <figure class="about-banner">
              <img
                src="./assets/img/anti-ragging-banner.png"
            ...
            <div class="about-content">
              <h2 class="h2 section-title">Anti Ragging  Committee</h2>

              <p class="section-subtitle">- Dr. Soumya Ghosh</p>
            </div>
          </div>
        </section>
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  ...
                  >
                    Member Civil And Polic Administration
                  </button>
                </h2>
                <div
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button
                    ...
                    aria-controls="flush-collapseThree"
                  >
                    Members of Faculty Representatives
                  </button>
                </h2>
                <div
                  ...
                  <div class="accordion-body">
                    <ol class="list-group list-group-numbered">
                      <li class="list-group-item">
                        Ranabir Saha, Lecturer (CST)
                      </li>
                      <li class="list-group-item">
                        Shubhajit Mondal, Lecturer (ME)
                      </li>
                      <li class="list-group-item">
                        Pronay Mondal, Lecturer (EE)
                      </li>
                      <li class="list-group-item">
                        Manab Kumar Ghosh, Lecturer (Basic Science)
                      </li>
                      <li class="list-group-item">
                        Sourav Das , Lecturer (ME)
                      </li>
                      <li class="list-group-item">
                        Firdousi Khatun, Lecturer (Basic Science)
                      </li>
                      <li class="list-group-item">
                        Ankita Chatterjee, Lecturer (EE)
                      </li>
                    </ol>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button
                    ...
                    aria-controls="flush-collapseThree"
                  >
                    Members of student Representatives
                  </button>
                </h2>
                <div
                ...
                >
                  <div class="accordion-body">
                    <ol class="list-group list-group-numbered">
                      <li class="list-group-item">MD Saif Ali</li>
                      <li class="list-group-item">Saleman Sultana</li>
                      <li class="list-group-item">Amit Garain</li>
                      <li class="list-group-item">Shitikanta Saha</li>
                      <li class="list-group-item">Debolina Ghosh</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    <ol class="list-group list-group-numbered">
                      <li class="list-group-item">Tumpa Roy</li>
                      <li class="list-group-item">Papia Haldar</li>
                    </ol>
                  </div>
                </div>
              </div>
