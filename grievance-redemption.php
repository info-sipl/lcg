...
<html lang="en">
  <head>
    ...
    <!--
        - primary meta tag
    -->
    <title>LCG | Grievance Redemption</title>
        ...
        <div class="container">
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              ...
              <h3>LAKSMAN CHANDRA GHOSH MEMORIAL SOCIETY</h3>
              <button
                class="navbar-toggle"
        ...
        <section class="section about" id="about" aria-label="about">
          <div class="container">
            <figure class="about-banner">
              <img
                src="./assets/img/comming-soon-banner.jpg"
            ...
            <div class="about-content">
              <h2 class="h2 section-title">Grievance Redemption Committee – 2024</h2>
