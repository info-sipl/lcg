...
<html lang="en">
  <head>
    ...
    <!--
        - primary meta tag
    -->
    <title>LCG | UTKARSH BANGLA</title>
        ...
        <div class="container">
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a href="./main_society.html">
                    <h2><b>LAKSMAN CHANDRA GHOSH MEMORIAL SOCIETY</b></h2>
                </a>        
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" href="./ub.html">
                          Project - UTKARSH BANGLA
                        </a>
                      </li>
                    </ul>
                  </li>
        ...
        <section class="section about" id="about" aria-label="about">
          <div class="container">
            ...
            <div class="about-content">
              <h2 class="h2 section-title">Our Project under UTKARSH BANGLA</h2>
